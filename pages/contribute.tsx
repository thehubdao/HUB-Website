            ...
            <main className="flex flex-col items-center text-gray-200 pt-28 lg:pt-48 w-full bg-[#111111]">
                ...
                <div className="flex flex-col items-center w-full max-w-screen-lg px-10 sm:px-10">
                    ...
                    <div className="flex flex-col lg:items-center space-x-0 space-y-10 w-full mb-10">
                        ...
                        <div className="flex flex-col relative text-center max-w-full p-10 items-center rounded-xl bg-[#292929]  border-transparent border-opacity-5 hover:scale-[1.02] transition duration-200 ease-linear ">
                            <p className={`font-normal text-md text-center max-w-xl mb-6`}>MGH is a Decentralized Autonomous Organization, which means that MGH is community-driven. Implementing the MGH working groups is a huge step towards more contributions from the community side and from everyone who is interested in contributing to MGH’s ecosystem by earning rewards in form of MGH tokens. At MGH, we envision working groups of the next generation of employment and are looking very forward to your application. Visit the <a href="https://www.notion.so/13613b99202d4829865e3e199490e8cf?v=f1d9d6776ed64cfbaac6959ce7fb1a67" target="_blank" className={`text-pink-reco`}>Operations Board</a> of the working groups to learn more about what MGH DAO is working on.</p>
