      ...
      <main className="flex flex-col items-center bg-gray-100 pt-20 lg:pt-32 pb-20">
        ...
        <div className="text-gray-200 p-6 md:p-10 max-w-full 2xl:max-w-screen-2xl">
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            TERMS and you represent that you have the authority and
            capacity to enter into these Terms.&nbsp;YOU SHOULD BE AT
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            these Terms.&nbsp; All copyright and other proprietary
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            rights expressed in Section 2.1. Company and its supplier's
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            incurred as the result of any such interactions.&nbsp; If
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            other harmful code, complete, legal, or safe.&nbsp; If
            applicable law requires any warranties with respect to the
            site, all such warranties are limited in duration to ninety
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            incapability to use the site even if the company has been
            advised of the possibility of such damages.&nbsp; Access to
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            one claim will not enlarge this limit.&nbsp; You agree that
            our suppliers will have no liability of any kind arising
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            your rights to use the Site at any time for any reason at
            our sole discretion, including for any use of the Site in
            violation of these Terms.&nbsp; Upon termination of your
            rights under these Terms, your Account and right to access
            and use the Site will terminate immediately.&nbsp; You
            understand that any termination of your Account may involve
            the deletion of your User Content associated with your
            Account from our live databases.&nbsp; The company will not
            have any liability whatsoever to you for any termination of
            your rights under these Terms.&nbsp; Even after your rights
            under these Terms are terminated, the following provisions
            of these Terms will remain in effect: Sections 2 through
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            property rights, including copyrights.&nbsp; If you believe
            that one of our users is, through the use of our Site,
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            in connection with the written notification and allegation
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            Site.&nbsp; You are responsible for providing us with your
            most current e-mail address.&nbsp; In the event that the
            last e-mail address that you have provided us is not valid
            our dispatch of the e-mail containing such notice will
            nonetheless constitute effective notice of the changes
            described in the notice.&nbsp; Any changes to these Terms
            will be effective upon the earliest of thirty (30) calendar
            days following our dispatch of an e-mail notice to you or
            thirty (30) calendar days following our posting of notice of
            ...
            Company and affects your rights.&nbsp; It contains
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            held in English.&nbsp; This Arbitration Agreement applies to
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            the requested relief.&nbsp; A Notice to the Company should
            be sent to Bredasingel 186 NA, Arnhem, 6844AT Netherlands.
            ...
            party may begin an arbitration proceeding.&nbsp; The amount
            of any settlement offer made by any party may not be
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            offers arbitration as set forth in this section.&nbsp; If
            AAA is not available to arbitrate, the parties shall agree
            to select an alternative ADR Provider.&nbsp; The rules of
            the ADR Provider shall govern all aspects of the arbitration
            except to the extent such rules are in conflict with the
            Terms.&nbsp; The AAA Consumer Arbitration Rules governing
            the arbitration are available online at
            [adr.org](http://adr.org/) or by calling the AAA at
            1-800-778-7879.&nbsp; The arbitration shall be conducted by
            a single, neutral arbitrator.&nbsp; Any claims or disputes
            where the total amount of the award sought is less than Ten
            ...
            Thousand U.S. Dollars (US $10,000.00) or more, the right to
            a hearing will be determined by the Arbitration Rules.&nbsp;
            ...
            jurisdiction.&nbsp; If the arbitrator grants you an award
            that is greater than the last settlement offer that the
            Company made to you prior to the initiation of arbitration,
            the Company will pay you the greater of the award or
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            the AAA Rules, and the Terms.&nbsp; The arbitrator shall
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            limited, more efficient, and less expensive than rules
            applicable in a court and are subject to very limited review
            by a court.&nbsp; In the event, any litigation should arise
            between you and the Company in any state or federal court in
            a suit to vacate or enforce an arbitration award or
            otherwise, YOU AND THE COMPANY WAIVE ALL RIGHTS TO A JURY
            TRIAL, instead electing that the dispute is resolved by a
            judge.
          </p>
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            that such communications would satisfy if it were in a hard
            copywriting.
          </p>
          ...
          <p className="py-1 text-black text-opacity-70">
            ...
            other.&nbsp; These Terms, and your rights and obligations
            ...
            be null and void.&nbsp; The company may freely assign these
