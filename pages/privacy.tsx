    ...
    <>
      ...
      <main className="flex flex-col items-center">
        ...
        <div className="text-gray-200 p-10 max-w-full 2xl:max-w-screen-2xl">
          <h1 className="text-5xl md:text-7xl font-bold mb-10">Privacy Policy</h1>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Consent</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Information we collect</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">How we use your information</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Log Files</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Advertising Partners Privacy Policies</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Third Party Privacy Policies</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">GDPR Data Protection Rights</h2>
          ...
          <h2 className="text-xl md:text-3xl mt-4 mb-2">Children's Information</h2>
