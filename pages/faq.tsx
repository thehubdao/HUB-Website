    ...
    <>
      ...
      <main className="flex flex-col items-center bg-gray-100">
        ...
        <div className="flex flex-col items-center text-black opacity-90 p-2 sm:p-10 w-full 2xl:max-w-screen-2xl">
          <h1 className="text-5xl md:text-7xl py-2 font-bold text-transparent bg-clip-text bg-gradient-to-br z-10 from-green-500 to-yellow-500 text-center m-20">Any Questions?</h1>
