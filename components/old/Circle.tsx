const Circle = () => {
    ...
    return (
        ...
        <><div className="relative place-self-end flex flex-col z-10 p-2 h-28 w-28 rounded-full bg-gray-400 bg-opacity-10 items-center justify-center">
            ...
            <span className="text-gray-400 text-xs font-medium z-10">Network Rewards</span>
        ...
        <div className="relative flex flex-col z-10 p-2 h-28 w-28 rounded-full bg-gray-400 bg-opacity-10 items-center justify-center">
                ...
                <span className="text-gray-400 text-xs font-medium z-10">Sales</span>
            ...
            <div className="relative place-self-end flex flex-col z-10 p-2 h-28 w-28 rounded-full bg-gray-400 bg-opacity-10 items-center justify-center">
                ...
                <span className="text-gray-400 text-xs font-medium z-10">DAO Treasury</span>
            ...
            <div className="relative flex flex-col z-10 p-2 h-28 w-28 rounded-full bg-gray-400 bg-opacity-10 items-center justify-center">
                ...
                <span className="text-gray-400 text-xs font-medium z-10">MGH Initiators</span>
