...
const Footer = () => {
  ...
  return (
    <footer className="relative flex flex-col lg:flex-row justify-around items-center space-y-20 lg:space-y-0 space-x-0 lg:space-x-10 px-2 sm:px-10 py-10 pb-16 w-full text-gray-200 overflow-hidden bg-[#111111]">
