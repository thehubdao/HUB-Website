const Solutions = () => {
    ...
    return (
        ...
        <div className="relative flex flex-col w-full h-full space-y-12 justify-center items-center p-8">
            <span className={`py-1 text-4xl sm:text-5xl xl:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-b z-10 from-blue-100  to-blue-500`}>Providing NFT Infrastructure</span>
