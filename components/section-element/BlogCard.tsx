const BlogCard = ({ title, article, date, link, classes }: any) => {
    ...
    return (
        <a href={link} target="_blank">
            <div className={`${classes} relative mr-10 flex flex-col p-3 pt-7 h-full w-80 max-w-sm rounded-md text-left bg-gray-300 hover:scale-[1.02] transition duration-200 ease-linear border border-white border-opacity-5 cursor-pointer`}>
