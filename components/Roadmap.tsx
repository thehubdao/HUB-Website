        ...
        <>
            <div className="w-full min-h-screen py-20">
                <div className={`w-full flex flex-col lg:flex-row items-center justify-start p-8`}>
                    <p className={`text-5xl sm:text-6xl font-bold text-gray-300 text-center lg:text-left 2xl:text-center`}>MGH DAO public launch is scheduled for the <span className={`text-transparent bg-clip-text bg-gradient-to-br z-10 from-blue-500 to-pink-500`}>14.10.21</span></p>
