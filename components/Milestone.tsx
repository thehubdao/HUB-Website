    ...
    return (
        ...
        <div className=" flex flex-row space-x-5 justify-center items-center w-full  m-5">
            <div className="flex-grow text-right w-2/5" >
                <span className="text-gray-400 text-lg lg:text-xl xl:text-2xl text-right">{date}</span>
            </div>
            ...
            <div className="flex-grow text-left w-2/5 " >
                <span className="text-gray-400 text-lg lg:text-xl xl:texl-2xl text-left">{text}</span>
            </div>
        </div>
        // </Fade>
    )
