            ...
            <div className={`sticky top-0 h-screen w-full`}>
                ...
                <div className={`absolute top-0 h-screen w-full z-20 flex justify-center items-center`}>
                    <div className={`${scroll > 10 ? "transition-all duration-1000 transform xl:translate-x-56 xl:-translate-y-0 -translate-y-32" : ""} flex flex-col items-center xl:items-start`}>
                        ...
                        <button className={`${scroll > 10 ? "opacity-100 transition-opacity delay-1000" : "opacity-0"} mt-5 transition-all duration-300 ease-in-out bg-black bg-opacity-50 border border-white border-opacity-25 hover:border-opacity-70 hover:shadow-color px-4 xl:px-6 py-2 xl:py-4 rounded-full`}>
                ...
                <div className={`absolute top-0 h-screen w-full xl:w-2/4 z-10 flex justify-center items-center transition-all duration-500 ${scroll > 10 ? "animate__animated animate__zoomIn animate__delay-1s" : "hidden"}`}>
                    ...
                    <span className={`w-full mt-20 xl:mt-0 sm:w-1/2 px-8 text-lg xl:text-2xl leading-normal text-gray-200 ${scroll > 2000 ? scroll < 4000 ? "block animate__animated animate__zoomIn animate_delay-0s" : "animate__animated animate__zoomOut animate_slower hidden" : "hidden"}`}>Disrupting the metaverse, a network of shared virtual spaces that are constantly evolving, unlocking new kinds of economies</span>
