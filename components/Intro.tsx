        ...
        <div className="text-center w-full" style={{ height: "3000px" }}>
            ...
            <div className={`sticky top-0 h-screen w-full`}>
                ...
                <div className={`absolute top-0 h-screen w-full z-20 flex justify-center items-center`}>
                    <div className={`${scroll > 10 && "transition-all duration-1000 transform xl:translate-x-64 xl:-translate-y-0 -translate-y-28"} flex flex-col items-center xl:items-start`}>
                ...
                <div className={`absolute font-medium top-0 h-screen w-full xl:w-2/4 z-10 flex justify-center items-center transition-all duration-500 ${scroll > 10 ? "animate__animated animate__zoomIn animate__delay-1s" : "hidden"}`}>
                    <span className={`w-full mt-20 lg:mt-32 xl:mt-0 sm:w-1/2 max-w-sm px-8 text-lg lg:text-xl xl:text-2xl leading-normal text-gray-200 ${scroll > 10 ? scroll < 1500 ? "block animate__animated animate__zoomIn animate_delay-0s" : "animate__animated animate__zoomOut animate_slower hidden" : "hidden"}`}>Utility, governance and data combined in one ecosystem</span>
                    <span className={`w-full mt-20 lg:mt-32 xl:mt-0 sm:w-1/2 max-w-xs px-8 texl-lg lg:text-xl xl:text-2xl leading-normal text-gray-200 ${scroll > 1500 ? scroll < 3000 ? "block animate__animated animate__zoomIn animate_delay-0s" : "animate__animated animate__zoomOut animate_slower hidden" : "hidden"}`}>AI NFT Pricing Oracle, Collaborative NFT Governance & Transparent NFT Pricing</span>
