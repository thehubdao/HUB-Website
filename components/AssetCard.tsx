  ...
  return (
    <a href={link} target='_blank'>
      ...
      >
        ...
        <p className='object-bottom px-3 py-2 pt-2.5 w-full rounded-b-2xl shadow-black bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm font-medium text-gray-200 text-sm lg:text-base'>
          {title}
        </p>
