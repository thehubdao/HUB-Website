    ...
    return (
        <div className="min-h-screen relative w-full py-10 flex flex-col space-y-10 items-center">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-5 place-items-center max-w-5xl w-full'>
                ...
                <a href='https://market.link/data-providers/5a443923-252a-4208-8b4e-b01c04ff6fa4/integrations' target="_blank" className='relative h-40 max-w-lg flex group items-center rounded bg-grey-darkest border border-white/5 p-5 hover:scale-[1.02] transition duration-200 ease-linear'>
                ...
                <a href='https://api.metagamehub.io' target="_blank" className='relative h-40 max-w-lg flex group items-center rounded bg-grey-darkest border border-white/5 p-5 hover:scale-[1.02] transition duration-200 ease-linear'>
