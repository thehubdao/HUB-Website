    ...
    <div className="max-w-screen-2xl m-auto h-full">
      <div className="w-full relative h-full">
        ...
        <div className="absolute w-full top-1/2 transform -translate-y-1/2 flex justify-between items-start px-3">
          <button type="button" className="flex absolute top-0 left-0 z-30 justify-center items-center px-4 h-full cursor-pointer group focus:outline-none target" onClick={handleOnPrevClick}>
